...
addpath(genpath('/home/abrotman/stability-preprocessing/MIN1PIPE')) % add MIN1PIPE repo to matlab path, this will prevent the proper installation of cvx toolbox in a fresh machine.
